...
require 'rbtype/deps/rails_autoload_location'
...
require 'rbtype/lint/missing_constant'
require 'rbtype/lint/rails/autoload_constants'
require 'rbtype/lint/rails/require_autoloadable_file'
